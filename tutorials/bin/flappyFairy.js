...
var thingsToLoad = ["images/flappyFairy/flappyFairy.json"];
...
function setupGame() {
  ...
  //Create the emitter
  dust = g.particleEmitter(300, //The interval
  function () {
...
function play() {
  ...
  if (fairyVsBlock && fairy.visible) {
    ...
    g.createParticles(fairy.centerX, fairy.centerY, //x and y position
    function () {
      return g.sprite(dustFrames);
    }, //Particle sprite
    g.stage, //The container to add the particles to 
...
//# sourceMappingURL=flappyFairy.js.map