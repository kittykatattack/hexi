...
var world = undefined,
    ...
    bombLayer = undefined,
    monsterLayer = undefined,
    monsterMapArray = undefined,
...
function isAtIntersection(sprite) {
  var trueOrFalse = Math.floor(alien.x) % world.tilewidth === 0 && Math.floor(alien.y) % world.tileheight === 0;
  return trueOrFalse;
}
//# sourceMappingURL=monsterMaze.js.map