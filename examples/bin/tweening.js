...
var g = hexi(1024, 512, setup, ["images/animals.json"]);
g.start();
...
function setup() {
  ...
  */
  ...
  var catSlide = g.slide(cat1, 400, 0, 60, "smoothstep", true, 0);
  ...
  var hedgehogPulse = g.pulse(hedgehog1, 120, 0.3);
  ...
  */
  ...
  var catBreathe = g.breathe(cat2, 1.4, 1.4, 60, true, 300);
  ...
  */
  ...
  var tigerStrobe = g.strobe(tiger2, 1.3, 10, 20, 10);
  ...
  var hedgehogWobble = g.wobble(hedgehog2, 1.8, 1.8);
