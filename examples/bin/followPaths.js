...
var g = hexi(512, 600, setup, ["images/animals.json"]);
g.start();
...
function setup() {
  ...
  var catPath = g.walkPath(cat, //The sprite
  ...
  //The hedgehog sprite
  var hedgehog = g.sprite("hedgehog.png");
  hedgehog.setPosition(32, 256);

  //Use `walkCurve` to make the hedgehog follow a curved path
  //between a series of connected waypoints. Here's how to use it:

  var hedgehogPath = g.walkCurve(hedgehog, //The sprite

  //An array of Bezier curve points that
  //you want to connect in sequence
  [[[hedgehog.x, hedgehog.y], [75, 500], [200, 500], [300, 300]], [[300, 300], [250, 100], [100, 100], [hedgehog.x, hedgehog.y]]], 300, //Total duration, in frames
  "smoothstep", //Easing type
  true, //Should the path loop?
...
//# sourceMappingURL=followPaths.js.map